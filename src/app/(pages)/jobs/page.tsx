      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        ...
        >
          ...
          <button
            ...
            className="border border-black/10 dark:border-white/10 rounded-2xl p-8 bg-white/5 dark:bg-white/5 hover:border-[#805abe]/30 hover:bg-[#805abe]/5 transition-colors duration-300 block text-left w-full"
          >
          ...
          <Link
            href="/jobs/ledger"
            className="border border-black/10 dark:border-white/10 rounded-2xl p-8 bg-white/5 dark:bg-white/5 hover:border-[#805abe]/30 hover:bg-[#805abe]/5 transition-colors duration-300 block"
          >
            <div className="flex items-center gap-3 mb-3">
